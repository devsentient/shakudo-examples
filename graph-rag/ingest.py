...
files = glob('/root/client-repo-avenue/extractor_job_v2/md_files/*/*.md')
...
graph.query(
  "CALL db.index.vector.createNodeIndex('avenue_chunk', 'Chunk', 'embedding', $dimension, 'cosine')",
  {"dimension": 768}
)

graph.query(
  "CALL db.index.vector.createNodeIndex('avenue_page', 'Page', 'embedding', $dimension, 'cosine')",
  {"dimension": 768}
)